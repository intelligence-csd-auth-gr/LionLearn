...
feature_importance('F48', 'Positive').
feature_importance('F49', 'Negative').
feature_importance('F50', 'Negative').
...
evaluated('F48','Positive','+','Increase').
evaluated('F49','Negative','+','Decrease').
evaluated('F49','Negative','-','Increase').
evaluated('F50','Negative','+','Decrease').
evaluated('F50','Negative','-','Increase').
